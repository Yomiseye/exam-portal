...
@php
    $paths = [
        ...
        'sparkles' => '<path d="M9.9 4.2 8.7 7.1 5.8 8.3l2.9 1.2 1.2 2.9 1.2-2.9 2.9-1.2-2.9-1.2Z"/><path d="M18.5 10.5 17.7 12.4 15.8 13.2l1.9.8.8 1.9.8-1.9 1.9-.8-1.9-.8Z"/><path d="M16 3l-.5 1.2L14.3 4.7l1.2.5L16 6.4l.5-1.2 1.2-.5-1.2-.5Z"/>',
